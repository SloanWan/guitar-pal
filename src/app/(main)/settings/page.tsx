...
const LABEL = "font-mono text-[9px] uppercase tracking-[0.2em] text-ink-faint";
const HELP = "font-mono text-[11px] tracking-[0.02em] text-ink-dim";
const INPUT =
	"w-full border border-line-strong bg-surface px-3 py-2 font-mono text-sm text-ink placeholder:text-ink-faint focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-1 focus-visible:outline-denim-accent disabled:opacity-50";
const BUTTON =
...
const PRIMARY = `${BUTTON} self-start bg-denim text-on-denim hover:bg-denim-accent`;
const SECONDARY = `${BUTTON} border border-line-strong text-ink-dim hover:border-denim hover:text-denim-accent`;
