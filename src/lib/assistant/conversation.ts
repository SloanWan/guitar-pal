...
/**
 * One transcript for the one assistant. The strum page and the fingerpick
 * page open the same thread: what was said on one is still there on the
 * other, and a card offered on one page takes the player to the page it is
 * for.
 */
