...
import { TAB_STYLES, planFromMeasure, stylePreset, type TabStyleEntry } from "@/lib/assistant/tab/styles";
import { splitTicks } from "@/lib/assistant/tab/ticks";
import type { ChordWord, PlanSlot, TabProposal } from "@/lib/assistant/tab/types";
