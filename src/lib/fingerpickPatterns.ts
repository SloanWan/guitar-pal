			...
			slots: [
				{
					id: "zebra-m1-1",
					duration: "eighth",
					chord: { root: "C", suffix: "add9", voicingId: null },
					strings: [N(0), S(), S(), S(), N(3), S()],
				},
				...
				},
				{
					...
					chord: {
						root: "D",
						suffix: "69",
						voicingId: "8a315435-c1bc-459d-bcf4-8703943388b7",
					},
					strings: [S(), N(0), S(), S(), N(5), S()],
				},
			...
			slots: [
				{
					...
					chord: {
						root: "B",
						suffix: "m7",
						voicingId: "0534ef4e-ad9f-4f2d-8226-56925b9050b6",
					},
					strings: [N(2), S(), S(), S(), N(2), S()],
				},
				...
				},
				{
					id: "zebra-m2-7",
					duration: "eighth",
					chord: { root: "E", suffix: "minor", voicingId: null },
					strings: [N(0), S(), S(), S(), S(), N(0)],
				},
			...
			slots: [
				{
					...
					chord: {
						root: "C",
						suffix: "maj7",
						voicingId: "880eea05-0e36-4d9e-9f2f-d7cfede73643",
					},
		...
		// ── m5 ────────────────────────────────────────────────────────────
		{
			...
			slots: [
				...
				{ id: "zebra-m5-4", duration: "eighth", strings: [S(), N(0), S(), S(), S(), S()] },
				{
					id: "zebra-m5-5",
					duration: "eighth",
					chord: { root: "D", suffix: "major", voicingId: null },
					strings: [S(), S(), N(2), N(0), S(), S()],
				},
			...
			slots: [
				{
					...
					chord: {
						root: "B",
						suffix: "minor",
						voicingId: "b2609c3c-e0db-4282-b697-7f251ce07e6b",
					},
			...
			slots: [
				{
					id: "zebra-m8-1",
					duration: "eighth",
					chord: { root: "G", suffix: "major", voicingId: null },
					strings: [S(), S(), N(2), S(), S(), N(3)],
				},
			...
			slots: [
				{
					id: "birds-m1-1",
					duration: "sixteenth",
					chord: { root: "C", suffix: "major", voicingId: null },
					strings: [S(), N(1), S(), S(), N(3), S()],
				},
				{
					id: "birds-m1-2",
					duration: "sixteenth",
				...
				},
				{
					id: "birds-m1-4",
					duration: "sixteenth",
					strings: [N(3), S(), S(), S(), S(), S()],
				},
				{
					id: "birds-m1-5",
					duration: "sixteenth",
					strings: [S(), S(), S(), S(), N(3), S()],
				},
				{
					id: "birds-m1-6",
					duration: "sixteenth",
			...
			slots: [
				{
					id: "birds-m3-1",
					duration: "sixteenth",
					chord: { root: "A", suffix: "m7", voicingId: null },
					strings: [S(), N(1), S(), S(), N(0), S()],
				},
				{
					id: "birds-m3-2",
					duration: "sixteenth",
			...
			slots: [
				{
					...
					chord: {
						root: "D",
						suffix: "m7",
						voicingId: "1ed30fdf-27f5-4d05-b6c7-2dcdc36c9dd0",
					},
					strings: [S(), N(1), S(), N(0), S(), S()],
				},
				{
					id: "birds-m5-2",
					duration: "sixteenth",
			...
			slots: [
				{
					...
					chord: {
						root: "G",
						suffix: "add11",
						voicingId: "8bfc1a81-240a-4225-a061-ff716a308236",
					},
					strings: [S(), N(1), S(), S(), S(), N(3)],
				},
				{
					id: "birds-m7-2",
					duration: "sixteenth",
