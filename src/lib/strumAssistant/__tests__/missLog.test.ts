...
import { recordMiss, recordPick, readMisses, exportMisses } from "@/lib/strumAssistant/missLog";
import { explainEditIntent } from "@/lib/strumAssistant/editIntent";
...
describe("the record of misses", () => {
	...
	it("survives storage that is not there", () => {
		localStorage.setItem("guitarpal:strumAssistantMisses", "not json");
